...
const CATEGORY_HARD_RULES = [
  ...
  "Wealthsimple Tax → Technology / Software / Productivity & Creative.",
  ...
  "Airline / airfare / Trip.com / booking.com flights → Travel / Flights. Hotels / Airbnb → Travel / Lodging. Theme parks and paid tours → Travel / Attractions & Tours.",
  "Daycare, babysitting, kids clothing, PetSmart, vet → Family. Do not put trip hotels under Lifestyle or daily Uber under Travel.",
  "LCBO / beer store / wine shop → Food / Alcohol. Bar, pub, nightclub tab → Lifestyle / Entertainment / Bars & Pubs.",
