...
const FALLBACK_COLUMNS: Record<string, string[]> = {
  ...
  transaction_sections: ["legacyId", "name", "userId"],
  transaction_spreads: ["legacyId", "name", "targetPercent", "userId"],
  transaction_categories: ["legacyId", "name", "sectionLegacyId", "userId"],
  ...
  transaction_types: ["legacyId", "name", "userId"],
  transaction_kinds: ["legacyId", "name", "userId"],
