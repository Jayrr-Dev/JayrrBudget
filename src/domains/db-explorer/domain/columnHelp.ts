...
export const TABLE_HELP: Record<string, string> = {
  ...
  budgets:
    "Spend caps Piggy or you set (amount, cycle, start date, warn %, over %).",
...
export const COLUMN_HELP: Record<string, Record<string, string>> = {
  ...
  budgets: {
    ...
    amount: "Cap in the user's currency for the current cycle slice.",
    cycle:
      "How often the cap resets: daily, weekly, biweekly, monthly, yearly.",
    startDate: "YYYY-MM-DD the cycle slice starts repeating from.",
  ...
  piggy_pings: {
    ...
    icon: "Piggy icon key for the card artwork.",
