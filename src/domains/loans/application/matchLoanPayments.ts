...
export function parseTxnDescriptionLookups(
...
export function serializeTxnDescriptionLookups(values: string[]): string {
  return parseTxnDescriptionLookups(values.join("\n")).join("\n");
}
