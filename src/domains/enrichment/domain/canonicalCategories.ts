...
const COMPOUND_SPLITS: Record<string, CompoundSplit> = {
  "food and drink": {
    left: "Groceries",
    right: "Drink",
    rightHint: /coffee|cafe|caf[eé]|drink|beverage|tea|juice|smoothie/i,
  },
...
const ALIASES: Record<string, CanonicalCategory> = {
  ...
  cheque: "External Transfers",
  cheques: "External Transfers",
  "wire transfer": "External Transfers",
  "wire transfers": "External Transfers",
...
export function canonicalCategoryAiRules() {
  return [
    ...
    "- External Transfers = e-Transfer to/from a person, remittance, GLOBAL MONEY TRANSFER, P2P, CHEQUE cleared through transit, bank wire. Money left the household.",
    ...
    "- Employment = Salary (fixed annual pay, same cheque each period), Wages (paid per hour, overtime or short weeks change the amount), Bonus, Contractor Pay. Payroll deposits stay Employment; pick Salary vs Wages from how they are paid. Cashback = cashback / remise en argent.",
