...
const ALIASES: Record<string, CanonicalCategory> = {
  ...
  pharmacies: "Medical",
  insurance: "Insurance",
  "student loans": "Debt & Loans",
  "student loan": "Debt & Loans",
  "buy now pay later": "Debt & Loans",
  loans: "Debt & Loans",
...
export function canonicalCategoryAiRules() {
  return [
    ...
    "- Travel = trip spend only: Flights, Lodging, Attractions & Tours. Not a tag. Not a category.",
    ...
    "- Lifestyle = shopping, entertainment, personal care, fitness, recreational. Bars and pubs are Entertainment, not Alcohol.",
    "",
    ...
    "- Drink vs Alcohol vs bars: coffee/tea/juice = Drink; LCBO/beer store = Alcohol; bar, pub, nightclub tab = Entertainment / Bars & Pubs.",
    ...
    "- Hair: Barbers & Salons under Personal Care. Do not invent Hair Salons or Barbers as categories.",
    "",
    "MERGE RULES (never split these):",
    "- Debt & Loans = Loan Payments, Student Loans, BNPL, LOC principal PAD. One bucket.",
    ...
    "- Employment = Salary and Wages, payroll, PAY UTILITEK. Cashback & Rebates = cashback / remise en argent.",
    "- Government & Tax = GST/HST credit, tax credits, tax refunds.",
    ...
    "",
    "DO NOT CREATE: Food and Drink, Food as a category, Delivery Services, Restaurants & Cafes, Software and Subscriptions, Software & Subscriptions, Subscriptions, Rent and Housing, Rideshare and Transit, Cash, ATM, Hair Salons, Barbers, Loan Payments, Student Loans, Remittance, Airlines, Automotive, Auto Dealers and Services, Salary and Wages, Rewards and Cashback, Rewards and Rebates, Bank Transfers, Tax Benefits and Credits, Tax Refunds, International Transfers, Utilities, Rent, Sightseeing, Travel as a category or tag, Auto, Loans, Bank Fees, Money Transfers, Employment Income, Rewards, Pets under Lifestyle, Education under Lifestyle, Career under Lifestyle, Books under Entertainment, Bars under Alcohol.",
  ].join("\n");
}
