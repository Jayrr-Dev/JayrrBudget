...
export const MERCHANT_CLEAN_AI_RULES = [
  ...
  "- Donair & Shawarma House Edmonton Ab Restaurants 14.70 → Donair & Shawarma House",
  "- OpenAI Subscr Ca Foreign Currency Transactions 29.82 → OpenAI",
  "- Zoho-Zoho Corp Cornwall on Home and Office Improvement 19.69 → Zoho",
  "- 7-Eleven Store Edmonton Ab Transportation 76.10 → 7-Eleven",
  "- Amzn Mktp Ca (refund) → Amazon",
  "- Amazon.ca AMAZON.CA → Amazon",
  "- Glasshouse Kitchen & B St Albert → Glasshouse Kitchen",
  "The bank spend column is not part of the name: Restaurants, Transportation, Home and Office Improvement, Foreign Currency Transactions, Retail and Grocery, Health and Education, Personal and Household Expenses, Professional and Financial Services, Digital Content, Software and Subscriptions.",
  "Never truncate with ellipsis. Never leave PHP, @, a city, a spend label, or a trailing amount in the merchant field.",
].join("\n");
