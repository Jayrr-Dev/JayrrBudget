...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex cursor-pointer items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md data-active:bg-primary-subtle data-active:text-primary-subtle-foreground data-active:hover:bg-primary-subtle data-active:focus:bg-primary-subtle [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
